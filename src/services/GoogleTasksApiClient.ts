...
export class GoogleTasksApiClient {
        ...
        return this.withRetry(async () => {
            ...
            try {
                ...
                throw new GoogleApiError(
                    `Google Tasks network request failed: ${error instanceof Error ? error.message : 'Unknown error'
                    }`,
                );
            }
    ...
    public async getTaskLists(accessToken: string): Promise<Array<{ id: string; title?: string }>> {
    ...
    public async createTaskList(accessToken: string, title: string): Promise<string> {
        ...
        try {
            await this.withRetry(async () => {
                ...
                try {
                    ...
                    throw new GoogleApiError(
                        `Google Calendar network request failed: ${error instanceof Error ? error.message : 'Unknown error'
                        }`,
                    );
                }
