 ...
 */
export const useEntranceAnimation = (itemCount: number, prefersReducedMotion: boolean) => {
    // Initialize animation values
    const fadeAnims = useRef([...Array(itemCount)].map(() => new Animated.Value(0))).current;
